...
#' @param conditions conditions for defining the replacement values, specified as a named list in `label=logical_vector` format, with the levels listed in the desired order
#'
#' @returns a factor
#' @export
#'
